 ...
 */
public class EntradaPontosDAO2 extends SQLiteOpenHelper implements EntradaPontosDAO {
    ...
    @Inject
    public EntradaPontosDAO2(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int versaoAnterior, int versaoAtual) {
        if (versaoAtual==2 && versaoAnterior==1){
